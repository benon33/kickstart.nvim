...
-- https://www.reddit.com/r/neovim/comments/108tjy0/nvimlspconfig_how_to_disable_hints_for_unused/
...
local function pyright_accessed_filter(diagnostic)
  ...
  if string.match(diagnostic.message, ".*is possibly unbound$") then
    return false
  end
...
return {
  ...
  config = function()
    ...
    mason_lspconfig.setup({
      ensure_installed = {
        "bashls", "eslint", "gopls", "jsonls", "marksman", "pyright",
